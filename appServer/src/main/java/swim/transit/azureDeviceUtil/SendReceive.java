package ai.swim.azureDeviceUtil;
...
public class SendReceive {
   ...
   * use MQTT transport.
   *
   * @param connString, protocolStr, msgStr, pathToCertificate
   * connString = IoT Hub connection string
   * protocolStr = number of requests to send
   * msgStr = protocol (optional, one of 'mqtt' or 'amqps' or 'https' or 'amqps_ws')
   * pathToCertificate = path to certificate to enable one-way authentication over ssl for amqps (optional, default shall be used if unspecified).
   */
